...
export const AddBranchesComponent = ({
  open,
  setOpen,
  onAddBranch,
  onEditBranch,
 ...
 const {refreshBranches} = useBranch();
  ...
  // Hook para obtener los empleados
  ...
  const validateFields = () => {
    ...
    const requiredFields = ["name", "calle", "numero_exterior", "colonia", "localidad", "municipio", "estado", "codigo_postal", "phone_number", "gerente_id"];


    requiredFields.forEach((key)=> {
      if(!formData[key]) {
        newErrors[key] = "Campo es requerido";
      }
    }); 
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
        <h5 style={{ margin: 16 }}>Información de la sucursal</h5>
        <TextField
          variant="outlined"
          label="Nombre"
          fullWidth
        ...
        <h5 style={{ margin: 16 }}>Información de contacto</h5>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <TextField
              variant="outlined"
          ...
          <Grid item xs={12}>
            <FormControl fullWidth required error={!!errors.gerente_id}>
